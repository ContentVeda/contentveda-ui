Feature: Vue target
  ...
  I want every component's compiled Vue output to render correctly
  So that Vue apps get the same behavior as the Svelte and Web Component targets

  Scenario: Banner renders content and animates its background effect
    Given I mount the "Banner" Vue component with:
  ...
  Scenario: AnnouncementBar renders a linked message
    Given I mount the "AnnouncementBar" Vue component with:
  ...
  Scenario: GridBanner renders every item as a card
    Given I mount the "GridBanner" Vue component with:
      | columns | 3                                                                                                                                                                                                              |
  ...
  Scenario: MediaGrid renders primary and secondary media
    Given I mount the "MediaGrid" Vue component with:
  ...
  Scenario: RowScrollable renders its title and items
    Given I mount the "RowScrollable" Vue component with:
  ...
  Scenario: SlidingBanner renders slides and animates its background effect
    Given I mount the "SlidingBanner" Vue component with:
  ...
  Scenario: AlternatingSlider renders the configured columns
    Given I mount the "AlternatingSlider" Vue component with:
  ...
  Scenario: TimerWidget renders a countdown and animates its background effect
    Given I mount the "TimerWidget" Vue component with:
      | title            | Sale Ends In          |
  ...
  Scenario: WysiwygRenderer renders semantic HTML
    Given I mount the "WysiwygRenderer" Vue component with:
  ...
  Scenario: RichTextEditor renders its toolbar and initial content
    Given I mount the "RichTextEditor" Vue component with:
  ...
  Scenario: Banner renders without errors in SSR mode
    Given I SSR mount the "Banner" "Vue" component with:
      | title | SSR Test |
    Then it should render without any page errors
