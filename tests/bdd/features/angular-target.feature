Feature: Angular target
  ...
  I want every component's compiled Angular output to render correctly
  So that Angular apps get the same behavior as the other targets
  ...
  Scenario: AnnouncementBar renders a linked message
    Given I mount the "AnnouncementBar" Angular component with:
  ...
  Scenario: GridBanner renders every item as a card
    Given I mount the "GridBanner" Angular component with:
      | columns | 3                                                                                                                                                                                                              |
  ...
  Scenario: MediaGrid renders primary and secondary media
    Given I mount the "MediaGrid" Angular component with:
  ...
  Scenario: RowScrollable renders its title and items
    Given I mount the "RowScrollable" Angular component with:
  ...
  Scenario: SlidingBanner renders slides and animates its background effect
    Given I mount the "SlidingBanner" Angular component with:
  ...
  Scenario: AlternatingSlider renders the configured columns
    Given I mount the "AlternatingSlider" Angular component with:
  ...
  Scenario: TimerWidget renders a countdown and animates its background effect
    Given I mount the "TimerWidget" Angular component with:
      | title            | Sale Ends In          |
  ...
  Scenario: WysiwygRenderer renders semantic HTML
    Given I mount the "WysiwygRenderer" Angular component with:
  ...
  Scenario: RichTextEditor renders its toolbar and initial content
    Given I mount the "RichTextEditor" Angular component with:
  ...
  Scenario: Banner renders without errors in SSR mode
    Given I SSR mount the "Banner" "Angular" component with:
      | title | SSR Test |
    Then it should render without any page errors
