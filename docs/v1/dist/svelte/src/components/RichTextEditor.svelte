    ...
    {#if showToolbarOption("headings")}
      <select
        ...
        ><option
          ...
          value="P"
          class="bg-slate-800">Paragraph</option
        ><option
          style={stringifyStyles({
            fontSize: "24px",
            fontWeight: "bold",
          ...
          value="H1"
          class="bg-slate-800">Heading 1</option
        ><option
          style={stringifyStyles({
            fontSize: "20px",
            fontWeight: "bold",
          ...
          value="H2"
          class="bg-slate-800">Heading 2</option
        ><option
          style={stringifyStyles({
            fontSize: "18px",
            fontWeight: "bold",
          ...
          value="H3"
          class="bg-slate-800">Heading 3</option
        ></select
      >
    {/if}
    {#if showSeparator(2)}
        ...
        {#if activeFormats.inTable && showToolbarOption("table")}
          ...
          >
            ...
            ><button
              ...
              ><span class="text-[10px] font-bold ml-0.5">R</span></button
            >
            <div class="w-px h-4 bg-violet-500/30 mx-0.5" />
            <button
              type="button"
              class="w-7 h-7 flex items-center justify-center rounded hover:bg-violet-500/40 text-violet-300 transition-colors"
