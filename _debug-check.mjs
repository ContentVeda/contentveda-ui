...
const runsResp = await page.goto('https://api.github.com/repos/ContentVeda/contentveda-ui/actions/runs?per_page=10');
...
if (!run) {
  ...
  if (run.status === 'completed') {
    if (run.conclusion !== 'success') {
      const crResp = await page.goto('https://api.github.com/repos/ContentVeda/contentveda-ui/commits/06c4eeb/check-runs');
      ...
      const relResp = await page.goto('https://api.github.com/repos/ContentVeda/contentveda-ui/releases?per_page=2');
