...
// @ts-ignore
import GridBanner from '@contentveda/ui/solid/GridBanner';
// @ts-ignore
...
// @ts-ignore
import SlidingBanner from '@contentveda/ui/solid/SlidingBanner';
// @ts-ignore
import AlternatingSlider from '@contentveda/ui/solid/AlternatingSlider';
// @ts-ignore
import CustomContentBlock from '@contentveda/ui/solid/CustomContentBlock';

export default function App() {
  const [editorContent, setEditorContent] = createSignal(
    '<h2>⚡ Rich Text Editor in Solid JS</h2><p>Rendered natively inside Solid with fine-grained reactivity and complete feature fidelity.</p><ul><li>Zero virtual DOM overhead</li><li>Seamless CSS chip and typography styling</li><li>Universal component architecture</li></ul>'
  );

  return (
    <main style={{ "max-width": "1100px", margin: "0 auto", padding: "2rem 1.5rem", "font-family": "system-ui, sans-serif", color: "#f1f5f9", background: "#020617", "min-height": "100vh" }}>
      <header style={{ "text-align": "center", "margin-bottom": "3rem" }}>
        <h1 style={{ "font-size": "2.5rem", color: "#38bdf8", "margin-bottom": "0.5rem" }}>ContentVeda UI — Solid Demo</h1>
        <p style={{ color: "#94a3b8", "font-size": "1.1rem" }}>Comprehensive showcase of all 11 core components running on Solid JS</p>
      </header>

      {/* 1. Announcement Bar */}
      <section style={{ "margin-bottom": "3.5rem" }}>
        <h2 style={{ color: "#7dd3fc", "font-size": "1.5rem", "margin-bottom": "1rem", "border-bottom": "1px solid #1e293b", "padding-bottom": "0.5rem" }}>1. Announcement Bar</h2>
        <AnnouncementBar
      ...
      {/* 2. Timer Widget */}
      <section style={{ "margin-bottom": "3.5rem" }}>
        <h2 style={{ color: "#7dd3fc", "font-size": "1.5rem", "margin-bottom": "1rem", "border-bottom": "1px solid #1e293b", "padding-bottom": "0.5rem" }}>2. Timer Widget</h2>
        <div style={{ display: "grid", "grid-template-columns": "repeat(auto-fit, minmax(300px, 1fr))", gap: "1.5rem" }}>
          <div>
            <h3 style={{ "font-size": "1.1rem", color: "#94a3b8", "margin-bottom": "0.5rem" }}>Standard Dark Variant</h3>
            <TimerWidget
          ...
          <div>
            <h3 style={{ "font-size": "1.1rem", color: "#94a3b8", "margin-bottom": "0.5rem" }}>Neon Variant with Image Background</h3>
            <TimerWidget
      ...
      {/* 3. Banner */}
      <section style={{ "margin-bottom": "3.5rem" }}>
        <h2 style={{ color: "#7dd3fc", "font-size": "1.5rem", "margin-bottom": "1rem", "border-bottom": "1px solid #1e293b", "padding-bottom": "0.5rem" }}>3. Banner (with Interactive Hotspots)</h2>
        <Banner
      ...
      {/* 4. Grid Banner */}
      <section style={{ "margin-bottom": "3.5rem" }}>
        <h2 style={{ color: "#7dd3fc", "font-size": "1.5rem", "margin-bottom": "1rem", "border-bottom": "1px solid #1e293b", "padding-bottom": "0.5rem" }}>4. Grid Banner</h2>
        <GridBanner
          columns={3}
          items={[
      ...
      {/* 5. Media Grid */}
      <section style={{ "margin-bottom": "3.5rem" }}>
        <h2 style={{ color: "#7dd3fc", "font-size": "1.5rem", "margin-bottom": "1rem", "border-bottom": "1px solid #1e293b", "padding-bottom": "0.5rem" }}>5. Media Grid</h2>
        <MediaGrid
      ...
      {/* 6. Row Scrollable */}
      <section style={{ "margin-bottom": "3.5rem" }}>
        <h2 style={{ color: "#7dd3fc", "font-size": "1.5rem", "margin-bottom": "1rem", "border-bottom": "1px solid #1e293b", "padding-bottom": "0.5rem" }}>6. Row Scrollable</h2>
        <RowScrollable
      ...
      {/* 7. Sliding Banner */}
      <section style={{ "margin-bottom": "3.5rem" }}>
        <h2 style={{ color: "#7dd3fc", "font-size": "1.5rem", "margin-bottom": "1rem", "border-bottom": "1px solid #1e293b", "padding-bottom": "0.5rem" }}>7. Sliding Banner</h2>
        <SlidingBanner
      ...
      <section style={{ "margin-bottom": "3.5rem" }}>
        <h2 style={{ color: "#7dd3fc", "font-size": "1.5rem", "margin-bottom": "1rem", "border-bottom": "1px solid #1e293b", "padding-bottom": "0.5rem" }}>8. Alternating Slider</h2>
        <AlternatingSlider
      ...
      <section style={{ "margin-bottom": "3.5rem" }}>
        <h2 style={{ color: "#7dd3fc", "font-size": "1.5rem", "margin-bottom": "1rem", "border-bottom": "1px solid #1e293b", "padding-bottom": "0.5rem" }}>9. Custom Content Block</h2>
        <CustomContentBlock
      ...
      <section style={{ "margin-bottom": "3.5rem" }}>
        <h2 style={{ color: "#7dd3fc", "font-size": "1.5rem", "margin-bottom": "1rem", "border-bottom": "1px solid #1e293b", "padding-bottom": "0.5rem" }}>10. Rich Text Editor &amp; 11. WYSIWYG Renderer</h2>
        <div style={{ display: "grid", "grid-template-columns": "repeat(auto-fit, minmax(400px, 1fr))", gap: "1.5rem" }}>
          <div>
            <h3 style={{ "font-size": "1.1rem", color: "#94a3b8", "margin-bottom": "0.5rem" }}>Live Editor</h3>
            <div style={{ border: "1px solid #334155", "border-radius": "8px", overflow: "hidden", background: "#0f172a" }}>
              <RichTextEditor
          ...
          <div>
            <h3 style={{ "font-size": "1.1rem", color: "#94a3b8", "margin-bottom": "0.5rem" }}>Output Preview (WysiwygRenderer)</h3>
            <div style={{ padding: "1.25rem", border: "1px solid #334155", "border-radius": "8px", background: "#090d16", "min-height": "300px" }}>
