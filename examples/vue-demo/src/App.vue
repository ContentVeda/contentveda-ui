...
<template>
  <main class="demo-container">
    <header class="demo-header">
      <h1>ContentVeda UI — Vue 3 Demo</h1>
      <p>Comprehensive showcase of all 11 core components running on Vue 3 Composition API</p>
    </header>

    <!-- 1. Announcement Bar -->
    <section class="demo-section">
      <h2>1. Announcement Bar</h2>
      <AnnouncementBar
    ...
    <!-- 2. Timer Widget -->
    <section class="demo-section">
      <h2>2. Timer Widget</h2>
      <div class="grid-2">
        <div>
          <h3>Standard Dark Variant</h3>
          <TimerWidget
        ...
        <div>
          <h3>Neon Variant with Image Background</h3>
          <TimerWidget
    ...
    <!-- 3. Banner -->
    <section class="demo-section">
      <h2>3. Banner (with Interactive Hotspots)</h2>
      <Banner
    ...
    <section class="demo-section">
      <h2>10. Rich Text Editor &amp; 11. WYSIWYG Renderer</h2>
      <div class="grid-2">
        <div>
          <h3>Live Editor</h3>
          <div class="editor-wrap">
            <RichTextEditor
              ...
              @change="(html) => (editorContent = html)"
            />
          </div>
        </div>
        <div>
          <h3>Output Preview (WysiwygRenderer)</h3>
