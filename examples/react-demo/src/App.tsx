...
export default function App() {
  ...
  const generateReactCode = () => {
    ...
    return `import ${activeTab} from '@contentveda/ui/react/${activeTab}';
import '@contentveda/ui/theme.css';
import '@contentveda/ui/styles/components/${activeTab}.css';
${pluginImport}
...
${propLines.join('\n')}${pluginProp}
  ...
  const generateSvelteCode = () => {
    ...
    return `<script>
  import ${activeTab} from '@contentveda/ui/svelte/${activeTab}.svelte';
  import '@contentveda/ui/theme.css';
  import '@contentveda/ui/styles/components/${activeTab}.css';
${pluginScript}
</script>
...
<link rel="stylesheet" href="node_modules/@contentveda/ui/styles/components/${activeTab}.css" />
<script type="module" src="node_modules/@contentveda/ui/webcomponents/${activeTab}.js"></script>
